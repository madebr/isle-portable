...
typedef struct IDirectDraw3 IDirectDraw3;
...
typedef IDirectDraw              FAR *LPDIRECTDRAW;
typedef IDirectDraw2             FAR *LPDIRECTDRAW2;
typedef IDirectDrawSurface       FAR *LPDIRECTDRAWSURFACE;
typedef IDirectDrawSurface2      FAR *LPDIRECTDRAWSURFACE2;
typedef IDirectDrawSurface3      FAR *LPDIRECTDRAWSURFACE3;
...
{
        /*** IUnknown methods ***/
    /*0x00*/STDMETHOD(QueryInterface) (THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
    /*0x04*/STDMETHOD_(ULONG,AddRef) (THIS)  PURE;
    /*0x08*/STDMETHOD_(ULONG,Release) (THIS) PURE;
        /*** IDirectDraw methods ***/
    /*0x0c*/STDMETHOD(Compact)(THIS) PURE;
    /*0x10*/STDMETHOD(CreateClipper)(THIS_ DWORD, LPDIRECTDRAWCLIPPER FAR*, IUnknown FAR * ) PURE;
    /*0x14*/STDMETHOD(CreatePalette)(THIS_ DWORD, LPPALETTEENTRY, LPDIRECTDRAWPALETTE FAR*, IUnknown FAR * ) PURE;
    /*0x18*/STDMETHOD(CreateSurface)(THIS_  LPDDSURFACEDESC, LPDIRECTDRAWSURFACE FAR *, IUnknown FAR *) PURE;
    /*0x1c*/STDMETHOD(DuplicateSurface)( THIS_ LPDIRECTDRAWSURFACE, LPDIRECTDRAWSURFACE FAR * ) PURE;
    /*0x20*/STDMETHOD(EnumDisplayModes)( THIS_ DWORD, LPDDSURFACEDESC, LPVOID, LPDDENUMMODESCALLBACK ) PURE;
    /*0x24*/STDMETHOD(EnumSurfaces)(THIS_ DWORD, LPDDSURFACEDESC, LPVOID,LPDDENUMSURFACESCALLBACK ) PURE;
    /*0x28*/STDMETHOD(FlipToGDISurface)(THIS) PURE;
    /*0x2c*/STDMETHOD(GetCaps)( THIS_ LPDDCAPS, LPDDCAPS) PURE;
    /*0x30*/STDMETHOD(GetDisplayMode)( THIS_ LPDDSURFACEDESC) PURE;
    /*0x34*/STDMETHOD(GetFourCCCodes)(THIS_  LPDWORD, LPDWORD ) PURE;
    /*0x38*/STDMETHOD(GetGDISurface)(THIS_ LPDIRECTDRAWSURFACE FAR *) PURE;
    /*0x3c*/STDMETHOD(GetMonitorFrequency)(THIS_ LPDWORD) PURE;
    /*0x40*/STDMETHOD(GetScanLine)(THIS_ LPDWORD) PURE;
    /*0x44*/STDMETHOD(GetVerticalBlankStatus)(THIS_ LPBOOL ) PURE;
    /*0x48*/STDMETHOD(Initialize)(THIS_ GUID FAR *) PURE;
    /*0x4c*/STDMETHOD(RestoreDisplayMode)(THIS) PURE;
    /*0x50*/STDMETHOD(SetCooperativeLevel)(THIS_ HWND, DWORD) PURE;
    /*0x54*/STDMETHOD(SetDisplayMode)(THIS_ DWORD, DWORD,DWORD) PURE;
    /*0x58*/STDMETHOD(WaitForVerticalBlank)(THIS_ DWORD, HANDLE ) PURE;
};
#undef INTERFACE
...
{
        /*** IUnknown methods ***/
    /*0x000*/STDMETHOD(QueryInterface) (THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
    /*0x004*/STDMETHOD_(ULONG,AddRef) (THIS)  PURE;
    /*0x008*/STDMETHOD_(ULONG,Release) (THIS) PURE;
        /*** IDirectDrawSurface methods ***/
    /*0x00c*/STDMETHOD(AddAttachedSurface)(THIS_ LPDIRECTDRAWSURFACE) PURE;
    /*0x010*/STDMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT) PURE;
    /*0x014*/STDMETHOD(Blt)(THIS_ LPRECT,LPDIRECTDRAWSURFACE, LPRECT,DWORD, LPDDBLTFX) PURE;
    /*0x018*/STDMETHOD(BltBatch)(THIS_ LPDDBLTBATCH, DWORD, DWORD ) PURE;
    /*0x01c*/STDMETHOD(BltFast)(THIS_ DWORD,DWORD,LPDIRECTDRAWSURFACE, LPRECT,DWORD) PURE;
    /*0x020*/STDMETHOD(DeleteAttachedSurface)(THIS_ DWORD,LPDIRECTDRAWSURFACE) PURE;
    /*0x024*/STDMETHOD(EnumAttachedSurfaces)(THIS_ LPVOID,LPDDENUMSURFACESCALLBACK) PURE;
    /*0x028*/STDMETHOD(EnumOverlayZOrders)(THIS_ DWORD,LPVOID,LPDDENUMSURFACESCALLBACK) PURE;
    /*0x02c*/STDMETHOD(Flip)(THIS_ LPDIRECTDRAWSURFACE, DWORD) PURE;
    /*0x030*/STDMETHOD(GetAttachedSurface)(THIS_ LPDDSCAPS, LPDIRECTDRAWSURFACE FAR *) PURE;
    /*0x034*/STDMETHOD(GetBltStatus)(THIS_ DWORD) PURE;
    /*0x038*/STDMETHOD(GetCaps)(THIS_ LPDDSCAPS) PURE;
    /*0x03c*/STDMETHOD(GetClipper)(THIS_ LPDIRECTDRAWCLIPPER FAR*) PURE;
    /*0x040*/STDMETHOD(GetColorKey)(THIS_ DWORD, LPDDCOLORKEY) PURE;
    /*0x044*/STDMETHOD(GetDC)(THIS_ HDC FAR *) PURE;
    /*0x048*/STDMETHOD(GetFlipStatus)(THIS_ DWORD) PURE;
    /*0x04c*/STDMETHOD(GetOverlayPosition)(THIS_ LPLONG, LPLONG ) PURE;
    /*0x050*/STDMETHOD(GetPalette)(THIS_ LPDIRECTDRAWPALETTE FAR*) PURE;
    /*0x054*/STDMETHOD(GetPixelFormat)(THIS_ LPDDPIXELFORMAT) PURE;
    /*0x058*/STDMETHOD(GetSurfaceDesc)(THIS_ LPDDSURFACEDESC) PURE;
    /*0x05c*/STDMETHOD(Initialize)(THIS_ LPDIRECTDRAW, LPDDSURFACEDESC) PURE;
    /*0x060*/STDMETHOD(IsLost)(THIS) PURE;
    /*0x064*/STDMETHOD(Lock)(THIS_ LPRECT,LPDDSURFACEDESC,DWORD,HANDLE) PURE;
    /*0x068*/STDMETHOD(ReleaseDC)(THIS_ HDC) PURE;
    /*0x06c*/STDMETHOD(Restore)(THIS) PURE;
    /*0x070*/STDMETHOD(SetClipper)(THIS_ LPDIRECTDRAWCLIPPER) PURE;
    /*0x074*/STDMETHOD(SetColorKey)(THIS_ DWORD, LPDDCOLORKEY) PURE;
    /*0x078*/STDMETHOD(SetOverlayPosition)(THIS_ LONG, LONG ) PURE;
    /*0x07c*/STDMETHOD(SetPalette)(THIS_ LPDIRECTDRAWPALETTE) PURE;
    /*0x080*/STDMETHOD(Unlock)(THIS_ LPVOID) PURE;
    /*0x084*/STDMETHOD(UpdateOverlay)(THIS_ LPRECT, LPDIRECTDRAWSURFACE,LPRECT,DWORD, LPDDOVERLAYFX) PURE;
    /*0x088*/STDMETHOD(UpdateOverlayDisplay)(THIS_ DWORD) PURE;
    /*0x08c*/STDMETHOD(UpdateOverlayZOrder)(THIS_ DWORD, LPDIRECTDRAWSURFACE) PURE;
};
#undef INTERFACE
