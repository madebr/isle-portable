...
typedef void (CDECL *D3DRMOBJECTCALLBACK)(struct IDirect3DRMObject *obj, void *arg);
typedef void (CDECL *D3DRMFRAMEMOVECALLBACK)(struct IDirect3DRMFrame *frame, void *ctx, D3DVALUE delta);
typedef void (CDECL *D3DRMFRAME2MOVECALLBACK)(struct IDirect3DRMFrame2 *frame, void *ctx, D3DVALUE delta);
typedef void (CDECL *D3DRMFRAME3MOVECALLBACK)(struct IDirect3DRMFrame3 *frame, void *ctx, D3DVALUE delta);
typedef void (CDECL *D3DRMUPDATECALLBACK)(struct IDirect3DRMDevice *device, void *ctx, int count, D3DRECT *rects);
typedef void (CDECL *D3DRMDEVICE3UPDATECALLBACK)(struct IDirect3DRMDevice3 *device, void *ctx, int count, D3DRECT *rects);
typedef int (CDECL *D3DRMUSERVISUALCALLBACK)(struct IDirect3DRMUserVisual *visual, void *ctx, D3DRMUSERVISUALREASON reason, struct IDirect3DRMDevice *device, struct IDirect3DRMViewport *viewport);
typedef HRESULT (CDECL *D3DRMLOADTEXTURECALLBACK)(char *tex_name, void *arg, struct IDirect3DRMTexture **texture);
typedef HRESULT (CDECL *D3DRMLOADTEXTURE3CALLBACK)(char *tex_name, void *arg, struct IDirect3DRMTexture3 **texture);
typedef void (CDECL *D3DRMLOADCALLBACK)(struct IDirect3DRMObject *object, REFIID objectguid, void *arg);
typedef HRESULT (CDECL *D3DRMDOWNSAMPLECALLBACK)(struct IDirect3DRMTexture3 *texture, void *ctx, IDirectDrawSurface *src_surface, IDirectDrawSurface *dst_surface);
typedef HRESULT (CDECL *D3DRMVALIDATIONCALLBACK)(struct IDirect3DRMTexture3 *texture, void *ctx, DWORD flags, DWORD rect_count, RECT *rects);
...
{
            /*** IUnknown methods ***/
    /*0x00*/STDMETHOD_(HRESULT,QueryInterface)(THIS_ REFIID riid, void** ppvObject) PURE;
    /*0x04*/STDMETHOD_(ULONG,AddRef)(THIS) PURE;
    /*0x08*/STDMETHOD_(ULONG,Release)(THIS) PURE;
            /*** IDirect3DRMObject2 methods ***/
    /*0x0c*/STDMETHOD(AddDestroyCallback)(THIS_ D3DRMOBJECTCALLBACK cb, void *ctx) PURE;
    /*0x10*/STDMETHOD(Clone)(THIS_ IUnknown *outer, REFIID iid, void **out) PURE;
    /*0x14*/STDMETHOD(DeleteDestroyCallback)(THIS_ D3DRMOBJECTCALLBACK cb, void *ctx) PURE;
    /*0x18*/STDMETHOD(GetClientData)(THIS_ DWORD id, void **data) PURE;
    /*0x1c*/STDMETHOD(GetDirect3DRM)(THIS_ struct IDirect3DRM **d3drm) PURE;
    /*0x20*/STDMETHOD(GetName)(THIS_ DWORD *size, char *name) PURE;
    /*0x24*/STDMETHOD(SetClientData)(THIS_ DWORD id, void *data, DWORD flags) PURE;
    /*0x28*/STDMETHOD(SetName)(THIS_ const char *name) PURE;
    /*0x2c*/STDMETHOD(GetAge)(THIS_ DWORD flags, DWORD *age) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3DRMDevice,IDirect3DRMObject)
{
    ...
    /*0x2c*/STDMETHOD(Init)(THIS_ ULONG width, ULONG height) PURE;
    /*0x30*/STDMETHOD(InitFromD3D)(THIS_ IDirect3D *d3d, IDirect3DDevice *d3d_device) PURE;
    /*0x34*/STDMETHOD(InitFromClipper)(THIS_ IDirectDrawClipper *clipper, GUID *guid, int width, int height) PURE;
    /*0x38*/STDMETHOD(Update)(THIS) PURE;
    /*0x3c*/STDMETHOD(AddUpdateCallback)(THIS_ D3DRMUPDATECALLBACK cb, void *ctx) PURE;
    /*0x40*/STDMETHOD(DeleteUpdateCallback)(THIS_ D3DRMUPDATECALLBACK cb, void *ctx) PURE;
    /*0x44*/STDMETHOD(SetBufferCount)(THIS_ DWORD) PURE;
    /*0x48*/STDMETHOD_(DWORD, GetBufferCount)(THIS) PURE;
    /*0x4c*/STDMETHOD(SetDither)(THIS_ BOOL) PURE;
    /*0x50*/STDMETHOD(SetShades)(THIS_ DWORD) PURE;
    /*0x54*/STDMETHOD(SetQuality)(THIS_ D3DRMRENDERQUALITY) PURE;
    /*0x58*/STDMETHOD(SetTextureQuality)(THIS_ D3DRMTEXTUREQUALITY) PURE;
    /*0x5c*/STDMETHOD(GetViewports)(THIS_ struct IDirect3DRMViewportArray **array) PURE;
    /*0x60*/STDMETHOD_(BOOL, GetDither)(THIS) PURE;
    /*0x64*/STDMETHOD_(DWORD, GetShades)(THIS) PURE;
    /*0x68*/STDMETHOD_(DWORD, GetHeight)(THIS) PURE;
    /*0x6c*/STDMETHOD_(DWORD, GetWidth)(THIS) PURE;
    /*0x70*/STDMETHOD_(DWORD, GetTrianglesDrawn)(THIS) PURE;
    /*0x74*/STDMETHOD_(DWORD, GetWireframeOptions)(THIS) PURE;
    /*0x78*/STDMETHOD_(D3DRMRENDERQUALITY, GetQuality)(THIS) PURE;
    /*0x7c*/STDMETHOD_(D3DCOLORMODEL, GetColorModel)(THIS) PURE;
    /*0x80*/STDMETHOD_(D3DRMTEXTUREQUALITY, GetTextureQuality)(THIS) PURE;
    /*0x84*/STDMETHOD(GetDirect3DDevice)(THIS_ IDirect3DDevice **d3d_device) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3DRMDevice2,IDirect3DRMDevice)
{
    ...
    /*0x88*/STDMETHOD(InitFromD3D2)(THIS_ IDirect3D2 *d3d, IDirect3DDevice2 *device) PURE;
    /*0x8c*/STDMETHOD(InitFromSurface)(THIS_ GUID *guid, IDirectDraw *ddraw, IDirectDrawSurface *surface) PURE;
    /*0x90*/STDMETHOD(SetRenderMode)(THIS_ DWORD flags) PURE;
    /*0x94*/STDMETHOD_(DWORD, GetRenderMode)(THIS) PURE;
    /*0x98*/STDMETHOD(GetDirect3DDevice2)(THIS_ IDirect3DDevice2 **device) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3DRMViewport,IDirect3DRMObject)
{
    ...
    /*0x2c*/STDMETHOD(Init) (THIS_ IDirect3DRMDevice *device, struct IDirect3DRMFrame *camera, DWORD x, DWORD y, DWORD width, DWORD height) PURE;
    /*0x30*/STDMETHOD(Clear)(THIS) PURE;
    /*0x34*/STDMETHOD(Render)(THIS_ struct IDirect3DRMFrame *frame) PURE;
    /*0x38*/STDMETHOD(SetFront)(THIS_ D3DVALUE) PURE;
    /*0x3c*/STDMETHOD(SetBack)(THIS_ D3DVALUE) PURE;
    /*0x40*/STDMETHOD(SetField)(THIS_ D3DVALUE) PURE;
    /*0x44*/STDMETHOD(SetUniformScaling)(THIS_ BOOL) PURE;
    /*0x48*/STDMETHOD(SetCamera)(THIS_ struct IDirect3DRMFrame *camera) PURE;
    /*0x4c*/STDMETHOD(SetProjection)(THIS_ D3DRMPROJECTIONTYPE) PURE;
    /*0x50*/STDMETHOD(Transform)(THIS_ D3DRMVECTOR4D *d, D3DVECTOR *s) PURE;
    /*0x54*/STDMETHOD(InverseTransform)(THIS_ D3DVECTOR *d, D3DRMVECTOR4D *s) PURE;
    /*0x58*/STDMETHOD(Configure)(THIS_ LONG x, LONG y, DWORD width, DWORD height) PURE;
    /*0x5c*/STDMETHOD(ForceUpdate)(THIS_ DWORD x1, DWORD y1, DWORD x2, DWORD y2) PURE;
    /*0x60*/STDMETHOD(SetPlane)(THIS_ D3DVALUE left, D3DVALUE right, D3DVALUE bottom, D3DVALUE top) PURE;
    /*0x64*/STDMETHOD(GetCamera)(THIS_ struct IDirect3DRMFrame **camera) PURE;
    /*0x68*/STDMETHOD(GetDevice)(THIS_ IDirect3DRMDevice **device) PURE;
    /*0x6c*/STDMETHOD(GetPlane)(THIS_ D3DVALUE *left, D3DVALUE *right, D3DVALUE *bottom, D3DVALUE *top) PURE;
    /*0x70*/STDMETHOD(Pick)(THIS_ LONG x, LONG y, struct IDirect3DRMPickedArray **visuals) PURE;
    /*0x74*/STDMETHOD_(BOOL, GetUniformScaling)(THIS) PURE;
    /*0x78*/STDMETHOD_(LONG, GetX)(THIS) PURE;
    /*0x7c*/STDMETHOD_(LONG, GetY)(THIS) PURE;
    /*0x80*/STDMETHOD_(DWORD, GetWidth)(THIS) PURE;
    /*0x84*/STDMETHOD_(DWORD, GetHeight)(THIS) PURE;
    /*0x88*/STDMETHOD_(D3DVALUE, GetField)(THIS) PURE;
    /*0x8c*/STDMETHOD_(D3DVALUE, GetBack)(THIS) PURE;
    /*0x90*/STDMETHOD_(D3DVALUE, GetFront)(THIS) PURE;
    /*0x94*/STDMETHOD_(D3DRMPROJECTIONTYPE, GetProjection)(THIS) PURE;
    /*0x9c*/STDMETHOD(GetDirect3DViewport)(THIS_ IDirect3DViewport **viewport) PURE;
};
#undef INTERFACE
...
{
        /*** IUnknown methods ***/
    /*0x000*/STDMETHOD_(HRESULT,QueryInterface)(THIS_ REFIID riid, void** ppvObject) PURE;
    /*0x004*/STDMETHOD_(ULONG,AddRef)(THIS) PURE;
    /*0x008*/STDMETHOD_(ULONG,Release)(THIS) PURE;
        /*** IDirect3DRMObject methods ***/
    /*0x00c*/STDMETHOD(Clone)(THIS_ IUnknown *outer, REFIID iid, void **out) PURE;
    /*0x010*/STDMETHOD(AddDestroyCallback)(THIS_ D3DRMOBJECTCALLBACK cb, void *ctx) PURE;
    /*0x014*/STDMETHOD(DeleteDestroyCallback)(THIS_ D3DRMOBJECTCALLBACK cb, void *ctx) PURE;
    /*0x018*/STDMETHOD(SetAppData)(THIS_ LPVOID data) PURE;
    /*0x01c*/STDMETHOD_(LPVOID, GetAppData)(THIS) PURE;
    /*0x020*/STDMETHOD(SetName)(THIS_ const char *name) PURE;
    /*0x024*/STDMETHOD(GetName)(THIS_ DWORD *size, char *name) PURE;
    /*0x028*/STDMETHOD(GetClassName)(THIS_ DWORD *size, char *name) PURE;
        /*** IDirect3DRMFrame methods ***/
    /*0x02c*/STDMETHOD(AddChild)(THIS_ IDirect3DRMFrame *child) PURE;
    /*0x030*/STDMETHOD(AddLight)(THIS_ struct IDirect3DRMLight *light) PURE;
    /*0x034*/STDMETHOD(AddMoveCallback)(THIS_ D3DRMFRAMEMOVECALLBACK cb, void *ctx) PURE;
    /*0x038*/STDMETHOD(AddTransform)(THIS_ D3DRMCOMBINETYPE, D3DRMMATRIX4D) PURE;
    /*0x03c*/STDMETHOD(AddTranslation)(THIS_ D3DRMCOMBINETYPE, D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    /*0x040*/STDMETHOD(AddScale)(THIS_ D3DRMCOMBINETYPE, D3DVALUE sx, D3DVALUE sy, D3DVALUE sz) PURE;
    /*0x044*/STDMETHOD(AddRotation)(THIS_ D3DRMCOMBINETYPE, D3DVALUE x, D3DVALUE y, D3DVALUE z, D3DVALUE theta) PURE;
    /*0x048*/STDMETHOD(AddVisual)(THIS_ IDirect3DRMVisual *visual) PURE;
    /*0x04c*/STDMETHOD(GetChildren)(THIS_ struct IDirect3DRMFrameArray **children) PURE;
    /*0x050*/STDMETHOD_(D3DCOLOR, GetColor)(THIS) PURE;
    /*0x054*/STDMETHOD(GetLights)(THIS_ struct IDirect3DRMLightArray **lights) PURE;
    /*0x058*/STDMETHOD_(D3DRMMATERIALMODE, GetMaterialMode)(THIS) PURE;
    /*0x05c*/STDMETHOD(GetParent)(THIS_ IDirect3DRMFrame **parent) PURE;
    /*0x060*/STDMETHOD(GetPosition)(THIS_ IDirect3DRMFrame *reference, D3DVECTOR *return_position) PURE;
    /*0x064*/STDMETHOD(GetRotation)(THIS_ IDirect3DRMFrame *reference, D3DVECTOR *axis, D3DVALUE *return_theta) PURE;
    /*0x068*/STDMETHOD(GetScene)(THIS_ IDirect3DRMFrame **scene) PURE;
    /*0x06c*/STDMETHOD_(D3DRMSORTMODE, GetSortMode)(THIS) PURE;
    /*0x070*/STDMETHOD(GetTexture)(THIS_ struct IDirect3DRMTexture **texture) PURE;
    /*0x074*/STDMETHOD(GetTransform)(THIS_ D3DRMMATRIX4D return_matrix) PURE;
    /*0x078*/STDMETHOD(GetVelocity)(THIS_ IDirect3DRMFrame *reference, D3DVECTOR *return_velocity, BOOL with_rotation) PURE;
    /*0x07c*/STDMETHOD(GetOrientation)(THIS_ IDirect3DRMFrame *reference, D3DVECTOR *dir, D3DVECTOR *up) PURE;
    /*0x080*/STDMETHOD(GetVisuals)(THIS_ struct IDirect3DRMVisualArray **visuals) PURE;
    /*0x084*/STDMETHOD(GetTextureTopology)(THIS_ BOOL *wrap_u, BOOL *wrap_v) PURE;
    /*0x088*/STDMETHOD(InverseTransform)(THIS_ D3DVECTOR *d, D3DVECTOR *s) PURE;
    /*0x08c*/STDMETHOD(Load)(THIS_ void *filename, void *name, D3DRMLOADOPTIONS flags, D3DRMLOADTEXTURECALLBACK cb, void *ctx)PURE;
    /*0x090*/STDMETHOD(LookAt)(THIS_ IDirect3DRMFrame *target, IDirect3DRMFrame *reference, D3DRMFRAMECONSTRAINT constraint) PURE;
    /*0x094*/STDMETHOD(Move)(THIS_ D3DVALUE delta) PURE;
    /*0x098*/STDMETHOD(DeleteChild)(THIS_ IDirect3DRMFrame *child) PURE;
    /*0x09c*/STDMETHOD(DeleteLight)(THIS_ struct IDirect3DRMLight *light) PURE;
    /*0x0a0*/STDMETHOD(DeleteMoveCallback)(THIS_ D3DRMFRAMEMOVECALLBACK cb, void *ctx) PURE;
    /*0x0a4*/STDMETHOD(DeleteVisual)(THIS_ IDirect3DRMVisual *visual) PURE;
    /*0x0a8*/STDMETHOD_(D3DCOLOR, GetSceneBackground)(THIS) PURE;
    /*0x0ac*/STDMETHOD(GetSceneBackgroundDepth)(THIS_ IDirectDrawSurface **surface) PURE;
    /*0x0b0*/STDMETHOD_(D3DCOLOR, GetSceneFogColor)(THIS) PURE;
    /*0x0b4*/STDMETHOD_(BOOL, GetSceneFogEnable)(THIS) PURE;
    /*0x0b8*/STDMETHOD_(D3DRMFOGMODE, GetSceneFogMode)(THIS) PURE;
    /*0x0bc*/STDMETHOD(GetSceneFogParams)(THIS_ D3DVALUE *return_start, D3DVALUE *return_end, D3DVALUE *return_density) PURE;
    /*0x0c0*/STDMETHOD(SetSceneBackground)(THIS_ D3DCOLOR) PURE;
    /*0x0c4*/STDMETHOD(SetSceneBackgroundRGB)(THIS_ D3DVALUE red, D3DVALUE green, D3DVALUE blue) PURE;
    /*0x0c8*/STDMETHOD(SetSceneBackgroundDepth)(THIS_ IDirectDrawSurface *surface) PURE;
    /*0x0cc*/STDMETHOD(SetSceneBackgroundImage)(THIS_ struct IDirect3DRMTexture *texture) PURE;
    /*0x0d0*/STDMETHOD(SetSceneFogEnable)(THIS_ BOOL) PURE;
    /*0x0d4*/STDMETHOD(SetSceneFogColor)(THIS_ D3DCOLOR) PURE;
    /*0x0d8*/STDMETHOD(SetSceneFogMode)(THIS_ D3DRMFOGMODE) PURE;
    /*0x0dc*/STDMETHOD(SetSceneFogParams)(THIS_ D3DVALUE start, D3DVALUE end, D3DVALUE density) PURE;
    /*0x0e0*/STDMETHOD(SetColor)(THIS_ D3DCOLOR) PURE;
    /*0x0e4*/STDMETHOD(SetColorRGB)(THIS_ D3DVALUE red, D3DVALUE green, D3DVALUE blue) PURE;
    /*0x0e8*/STDMETHOD_(D3DRMZBUFFERMODE, GetZbufferMode)(THIS) PURE;
    /*0x0ec*/STDMETHOD(SetMaterialMode)(THIS_ D3DRMMATERIALMODE) PURE;
    /*0x0f0*/STDMETHOD(SetOrientation)(THIS_ IDirect3DRMFrame *reference, D3DVALUE dx, D3DVALUE dy, D3DVALUE dz, D3DVALUE ux, D3DVALUE uy, D3DVALUE uz) PURE;
    /*0x0f4*/STDMETHOD(SetPosition)(THIS_ IDirect3DRMFrame *reference, D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    /*0x0f8*/STDMETHOD(SetRotation)(THIS_ IDirect3DRMFrame *reference, D3DVALUE x, D3DVALUE y, D3DVALUE z, D3DVALUE theta) PURE;
    /*0x0fc*/STDMETHOD(SetSortMode)(THIS_ D3DRMSORTMODE) PURE;
    /*0x100*/STDMETHOD(SetTexture)(THIS_ struct IDirect3DRMTexture *texture) PURE;
    /*0x104*/STDMETHOD(SetTextureTopology)(THIS_ BOOL wrap_u, BOOL wrap_v) PURE;
    /*0x108*/STDMETHOD(SetVelocity)(THIS_ IDirect3DRMFrame *reference, D3DVALUE x, D3DVALUE y, D3DVALUE z, BOOL with_rotation) PURE;
    /*0x10c*/STDMETHOD(SetZbufferMode)(THIS_ D3DRMZBUFFERMODE) PURE;
    /*0x110*/STDMETHOD(Transform)(THIS_ D3DVECTOR *d, D3DVECTOR *s) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3DRMFrame2,IDirect3DRMFrame)
{
    ...
    /*0x114*/STDMETHOD(AddMoveCallback2)(THIS_ D3DRMFRAME2MOVECALLBACK cb, void *ctx, DWORD flags) PURE;
    /*0x118*/STDMETHOD(GetBox)(THIS_ D3DRMBOX *box) PURE;
    /*0x11c*/STDMETHOD_(BOOL, GetBoxEnable)(THIS) PURE;
    /*0x120*/STDMETHOD(GetAxes)(THIS_ D3DVECTOR *dir, D3DVECTOR *up);
    /*0x124*/STDMETHOD(GetMaterial)(THIS_ struct IDirect3DRMMaterial **material) PURE;
    /*0x128*/STDMETHOD_(BOOL, GetInheritAxes)(THIS);
    /*0x12c*/STDMETHOD(GetHierarchyBox)(THIS_ D3DRMBOX *box) PURE;
    /*0x130*/STDMETHOD(SetBox)(THIS_ D3DRMBOX *box) PURE;
    /*0x134*/STDMETHOD(SetBoxEnable)(THIS_ BOOL) PURE;
    /*0x138*/STDMETHOD(SetAxes)(THIS_ D3DVALUE dx, D3DVALUE dy, D3DVALUE dz, D3DVALUE ux, D3DVALUE uy, D3DVALUE uz);
    /*0x13c*/STDMETHOD(SetInheritAxes)(THIS_ BOOL inherit_from_parent);
    /*0x140*/STDMETHOD(SetMaterial)(THIS_ struct IDirect3DRMMaterial *material) PURE;
    /*0x144*/STDMETHOD(SetQuaternion)(THIS_ IDirect3DRMFrame *reference, D3DRMQUATERNION *q) PURE;
    /*0x148*/STDMETHOD(RayPick)(THIS_ IDirect3DRMFrame *reference, D3DRMRAY *ray, DWORD flags, struct IDirect3DRMPicked2Array **return_visuals) PURE;
    /*0x14c*/STDMETHOD(Save)(THIS_ const char *filename, D3DRMXOFFORMAT format, D3DRMSAVEOPTIONS flags);
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3DRMMeshBuilder,IDirect3DRMVisual)
{
    ...
    /*0x02c*/STDMETHOD(Load)(THIS_ void *filename, void *name, D3DRMLOADOPTIONS flags, D3DRMLOADTEXTURECALLBACK cb, void *ctx) PURE;
    /*0x030*/STDMETHOD(Save)(THIS_ const char *filename, D3DRMXOFFORMAT, D3DRMSAVEOPTIONS save) PURE;
    /*0x034*/STDMETHOD(Scale)(THIS_ D3DVALUE sx, D3DVALUE sy, D3DVALUE sz) PURE;
    /*0x038*/STDMETHOD(Translate)(THIS_ D3DVALUE tx, D3DVALUE ty, D3DVALUE tz) PURE;
    /*0x03c*/STDMETHOD(SetColorSource)(THIS_ D3DRMCOLORSOURCE) PURE;
    /*0x040*/STDMETHOD(GetBox)(THIS_ D3DRMBOX *) PURE;
    /*0x044*/STDMETHOD(GenerateNormals)(THIS) PURE;
    /*0x048*/STDMETHOD_(D3DRMCOLORSOURCE, GetColorSource)(THIS) PURE;
    /*0x04c*/STDMETHOD(AddMesh)(THIS_ IDirect3DRMMesh *mesh) PURE;
    /*0x050*/STDMETHOD(AddMeshBuilder)(THIS_ IDirect3DRMMeshBuilder *mesh_builder) PURE;
    /*0x054*/STDMETHOD(AddFrame)(THIS_ IDirect3DRMFrame *frame) PURE;
    /*0x058*/STDMETHOD(AddFace)(THIS_ IDirect3DRMFace *face) PURE;
    /*0x05c*/STDMETHOD(AddFaces)(THIS_ DWORD vertex_count, D3DVECTOR *vertices, DWORD normal_count, D3DVECTOR *normals, DWORD *face_data, struct IDirect3DRMFaceArray **array) PURE;
    /*0x060*/STDMETHOD(ReserveSpace)(THIS_ DWORD vertex_Count, DWORD normal_count, DWORD face_count) PURE;
    /*0x064*/STDMETHOD(SetColorRGB)(THIS_ D3DVALUE red, D3DVALUE green, D3DVALUE blue) PURE;
    /*0x068*/STDMETHOD(SetColor)(THIS_ D3DCOLOR) PURE;
    /*0x06c*/STDMETHOD(SetTexture)(THIS_ struct IDirect3DRMTexture *texture) PURE;
    /*0x070*/STDMETHOD(SetMaterial)(THIS_ struct IDirect3DRMMaterial *material) PURE;
    /*0x074*/STDMETHOD(SetTextureTopology)(THIS_ BOOL wrap_u, BOOL wrap_v) PURE;
    /*0x078*/STDMETHOD(SetQuality)(THIS_ D3DRMRENDERQUALITY) PURE;
    /*0x07c*/STDMETHOD(SetPerspective)(THIS_ BOOL) PURE;
    /*0x080*/STDMETHOD(SetVertex)(THIS_ DWORD index, D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    /*0x084*/STDMETHOD(SetNormal)(THIS_ DWORD index, D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    /*0x088*/STDMETHOD(SetTextureCoordinates)(THIS_ DWORD index, D3DVALUE u, D3DVALUE v) PURE;
    /*0x08c*/STDMETHOD(SetVertexColor)(THIS_ DWORD index, D3DCOLOR) PURE;
    /*0x090*/STDMETHOD(SetVertexColorRGB)(THIS_ DWORD index, D3DVALUE red, D3DVALUE green, D3DVALUE blue) PURE;
    /*0x094*/STDMETHOD(GetFaces)(THIS_ struct IDirect3DRMFaceArray **array) PURE;
    /*0x098*/STDMETHOD(GetVertices)(THIS_ DWORD *vcount, D3DVECTOR *vertices, DWORD *ncount, D3DVECTOR *normals, DWORD *face_data_size, DWORD *face_data) PURE;
    /*0x09c*/STDMETHOD(GetTextureCoordinates)(THIS_ DWORD index, D3DVALUE *u, D3DVALUE *v) PURE;
    /*0x0a0*/STDMETHOD_(int, AddVertex)(THIS_ D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    /*0x0a4*/STDMETHOD_(int, AddNormal)(THIS_ D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    /*0x0a8*/STDMETHOD(CreateFace)(THIS_ IDirect3DRMFace **face) PURE;
    /*0x0ac*/STDMETHOD_(D3DRMRENDERQUALITY, GetQuality)(THIS) PURE;
    /*0x0b0*/STDMETHOD_(BOOL, GetPerspective)(THIS) PURE;
    /*0x0b4*/STDMETHOD_(int, GetFaceCount)(THIS) PURE;
    /*0x0b8*/STDMETHOD_(int, GetVertexCount)(THIS) PURE;
    /*0x0bc*/STDMETHOD_(D3DCOLOR, GetVertexColor)(THIS_ DWORD index) PURE;
    /*0x0c0*/STDMETHOD(CreateMesh)(THIS_ IDirect3DRMMesh **mesh) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3DRMMeshBuilder3,IDirect3DRMVisual)
{
    ...
    STDMETHOD(Load)(THIS_ void *filename, void *name, D3DRMLOADOPTIONS flags, D3DRMLOADTEXTURE3CALLBACK cb, void *ctx) PURE;
    STDMETHOD(Save)(THIS_ const char *filename, D3DRMXOFFORMAT, D3DRMSAVEOPTIONS save) PURE;
    STDMETHOD(Scale)(THIS_ D3DVALUE sx, D3DVALUE sy, D3DVALUE sz) PURE;
    STDMETHOD(Translate)(THIS_ D3DVALUE tx, D3DVALUE ty, D3DVALUE tz) PURE;
    STDMETHOD(SetColorSource)(THIS_ D3DRMCOLORSOURCE) PURE;
